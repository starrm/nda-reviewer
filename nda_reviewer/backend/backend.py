...
class Backend:
    ...
    def generate_redlined_docx(self, output_path):
        ...
        output = wrapper.run_redline(
            "NDA Reviewer", self.original_docx_path, self.revised_docx_path
        )
